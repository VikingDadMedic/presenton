            ...
            >
                ...
                <div className="absolute bottom-0 left-0 w-80 h-40 opacity-10 overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 300 150" fill="none">
                        <path d="M0 75C75 50 150 100 225 75C262.5 62.5 300 75 300 75V150H0V75Z" fill="var(--primary-color,#2563eb)" opacity="0.3" />
                        <path d="M0 100C100 125 200 75 300 100V125C225 112.5 150 125 75 112.5L0 100Z" fill="var(--primary-color,#2563eb)" opacity="0.2" />
                    </svg>
                </div>
                ...
                <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
                    ...
                    <div className="flex-1 flex flex-col justify-center pr-8 space-y-6">
                        ...
                        {/* Purple accent line */}
                        <div style={{ background: "var(--primary-color,#2563eb)" }} className="w-20 h-1 bg-blue-600"></div>
