...
# Simple branded success page for TripStory authentication
SUCCESS_HTML = """<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>TripStory – Authentication successful</title>
  <style>
    :root {
...
<body>
  <main class="card">
    ...
    <p>You can now return to TripStory to continue.</p>
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>TripStory – Authentication issue</title>
  <style>
...
<body>
  <main class="card">
    ...
    <p>We’ll gently reload this page. If the issue persists, close this window and restart sign-in from TripStory.</p>
