            ...
            >
                ...
                <div className="absolute bottom-0 left-0 w-48 h-48 opacity-10 overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 200 200" fill="none">
                        <path d="M0 100C50 75 100 125 150 100C175 87.5 200 100 200 100V200H0V100Z" fill="var(--primary-color,#2563eb)" opacity="0.4" />
                        <path d="M0 150C75 175 125 125 200 150V175C150 162.5 100 175 50 162.5L0 150Z" fill="var(--primary-color,#2563eb)" opacity="0.3" />
                    </svg>
                </div>

                <div className="absolute top-0 right-0 w-64 h-64 opacity-10 overflow-hidden">
                    <svg className="w-full h-full" viewBox="0 0 200 200" fill="none">
                        <path d="M100 0C150 50 200 0 200 50C200 100 150 150 100 150C50 150 0 100 0 50C0 0 50 50 100 0Z" fill="var(--primary-color,#2563eb)" opacity="0.2" />
                    </svg>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {metrics.map((metric, index) => (
                                <div key={index} className="text-center space-y-2">
                                    ...
                                    <div style={{ color: "var(--primary-color,#2563eb)" }} className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-600">
                                        {metric.value}
                                    </div>
                                </div>
                            ))}
