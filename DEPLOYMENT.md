...
**Migration call-out (narration revisions):**
...
Narration-related revisions include `6b8a7a3b8d1f` (narration columns) and `9d2f4f8429de` (usage logs). Keeping `MIGRATE_DATABASE_ON_STARTUP=true` in App Service also applies these on boot.
