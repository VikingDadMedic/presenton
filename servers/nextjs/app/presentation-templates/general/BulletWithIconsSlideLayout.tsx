                ...
                <div className="flex flex-col h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
                    ...
                    <div className="flex flex-1">
                        ...
                        <div className="flex-1 relative">
                                ...
                                <svg className="w-full h-full opacity-30" viewBox="0 0 200 200">
                                    <defs>
                                        <pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse">
                                            <path d="M 20 0 L 0 0 0 20" fill="none" stroke="var(--primary-color, #2563eb)" strokeWidth="0.5" />
                                        </pattern>
                                    </defs>
                            ...
                            {/* Decorative Sparkle */}
                            <div style={{ color: "var(--primary-color,#2563eb)" }} className="absolute top-20 right-8 text-blue-600">
                            ...
                            <div className="space-y-6">
                                {bulletPoints.map((bullet, index) => (
                                    <div key={index} className="flex items-start space-x-4">
                                        {/* Icon */}
                                        <div style={{ background: "var(--primary-color,#2563eb)" }} className="flex-shrink-0 w-12 h-12 rounded-lg shadow-md flex items-center justify-center">
                                            <RemoteSvgIcon
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div style={{ background: "var(--primary-color,#2563eb)" }} className="w-12 h-0.5 bg-blue-600 mb-3"></div>
