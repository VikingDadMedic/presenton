                ...
                <div className="px-8 sm:px-12 lg:px-20 pt-12 pb-8 h-full">
                    ...
                    <div className="flex items-start justify-between mb-8">
                        ...
                        <div className="flex-1 pr-8">
                            ...
                            {/* Purple accent line */}
                            <div style={{ background: "var(--primary-color,#2563eb)" }} className="w-24 h-1 bg-blue-600 mb-6"></div>
                        </div>
                        ...
                        >
                            ...
                            <defs>
                                <linearGradient id="wave-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                    ...
                                    <stop offset="50%" stopColor="var(--primary-color,#2563eb)" />
                                    <stop offset="100%" stopColor="var(--primary-color,#2563eb)" />
                                </linearGradient>
                            </defs>
                        </svg>
                    </div>
