...
export const PresentationGrid = ({
  ...
  const CreateNewCard = () => (
    <div
      ...
      className="flex flex-col cursor-pointer group ring-1 ring-inset ring-border hover:ring-[#8A7DFF]/40 bg-card/80 rounded-xl overflow-hidden transition-all duration-300 font-display"
    >
