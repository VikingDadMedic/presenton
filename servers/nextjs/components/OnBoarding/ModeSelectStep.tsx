    ...
    return (
        <div className='max-w-[650px]'>
            <div className='mb-[70px]'>
                ...
                <h2 className='mb-4 text-foreground text-[26px] font-normal font-display '>Choose how you want to generate presentations</h2>
            ...
            <div className='space-y-5'>
                ...
                }} className={`border font-display  rounded-[11px] p-3  flex items-center  justify-between gap-6 cursor-pointer ${selectedMode === "presenton" ? "border-primary" : "border-border"}`}>
                    <div className='flex items-center gap-6'>
                        ...
                        <div className=''>
                            <div className='flex items-start gap-2 relative '>
                                ...
                                <h3 className='text-foreground text-[18px] font-medium font-display'>Template Presentation Mode</h3>
                ...
                <div
                    className='border font-display border-border  cursor-not-allowed rounded-[11px] p-3  flex items-center  justify-between gap-6  relative'>
                    <p className='text-foreground absolute top-[20px] right-14 flex items-center justify-center text-[14px] font-normal bg-primary/5 px-3 py-1.5 rounded-[30px]'>Coming soon</p>
                    ...
                    <div className='flex items-center gap-6'>
                        ...
                        <div className=''>
                            <div className='flex items-start gap-2 relative '>
                                ...
                                <h3 className='text-foreground text-[18px] font-medium font-display'>Image Slides Mode</h3>
